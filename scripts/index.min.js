...
ticking=false;});}
ticking=true;});var scroll=new SmoothScroll('a[href*="#"]');toTopBtn&&toTopBtn.addEventListener('click',function(){scroll.animateScroll(0);});var linkList=document.querySelectorAll('.post-content a');for(var i in linkList){linkList[i].setAttribute('target','_blank');}